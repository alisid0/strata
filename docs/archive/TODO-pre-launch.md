> **Archived — non-authoritative.** Pre-launch scratch TODO (password gate,
> 78-board inventory, old deploy flow). Current ops status lives in
> `docs/PUBLIC-BETA-CHECKLIST.md` and `docs/SOURCE-OF-TRUTH.md`.
