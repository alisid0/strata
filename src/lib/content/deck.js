...
export const DECK = [
  ...
  C("V","Card 38","A line that holds every number",[
  ...
  C("V","Card 39","The point everything is measured from",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"zero; origin-1d",ground:"g0",buildsOn:["Card 38"]}),

  C("V","Card 40","Two directions from zero",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"positive-negative; sign-as-direction",ground:"g0",buildsOn:["Card 39"]}),

  C("V","Card 41","The gaps between the whole numbers",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"fractions-decimals-on-line; density",ground:"g0",buildsOn:["Card 38"]}),

  C("V","Card 42","The line settles every argument about size",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"comparing-numbers; ordering; infinity-notation",ground:"g0",buildsOn:["Card 40"]}),

  C("V","Card 43","Subtraction is just a length",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"distance-1d; subtraction-as-length",ground:"g0",buildsOn:["Card 40"]}),

  C("V","Card 44","The exact middle, found by averaging",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"midpoint-1d",ground:"g0",buildsOn:["Card 43"]}),

  C("V","Card 45","One line can't hold everything",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"limits-of-1d; need-for-2d",ground:"g0",buildsOn:["Card 38"]}),

  C("V","Card 46","Two number lines, crossed at a right angle",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"x-axis; y-axis; cartesian-plane",ground:"g0",buildsOn:["Card 45"]}),

  C("V","Card 47","Where the two lines meet",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"origin-2d",ground:"g0",buildsOn:["Card 46"]}),

  C("V","Card 48","Every place on the grid has an address",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"plotting-points; ordered-pair",ground:"g0",buildsOn:["Card 46","Card 47"]}),

  C("V","Card 49","Going backwards: point to address",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"reading-coordinates",ground:"g0",buildsOn:["Card 48"]}),

  C("V","Card 50","The grid splits into four rooms",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"quadrants",ground:"g0",buildsOn:["Card 48"]}),

  C("V","Card 51","The signs of x and y give it away",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"quadrant-signs",ground:"g0",buildsOn:["Card 50"]}),

  C("V","Card 52","Borrowing a triangle to measure a diagonal",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"distance-formula-2d; pythagoras",ground:"g0",buildsOn:["Card 43","Card 48"]}),

  C("V","Card 53","Averaging both coordinates at once",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"midpoint-2d",ground:"g0",buildsOn:["Card 44","Card 48"]}),

  C("V","Card 54","A shape is just a few points, joined up",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"shapes-from-points",ground:"g0",buildsOn:["Card 48"]}),

  C("V","Card 55","Did you know? The footnote that ate the book",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"history-descartes",kind:"snippet",ground:"g0",buildsOn:["Card 46"]}),

  C("V","Card 56","Quick things to remember — Tier 0",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"tier-0-recap",kind:"recap",ground:"g0",buildsOn:["Card 54"]}),

  C("V","Card 57","How much a line leans",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"steepness-intro; constant-rate",ground:"g0",buildsOn:["Card 48"]}),

  C("V","Card 58","How far up, how far along",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"delta-y; delta-x; rise-run",ground:"g0",buildsOn:["Card 57"]}),

  C("V","Card 59","Turning the lean into one number",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"gradient; slope",ground:"g0",buildsOn:["Card 58","Card 52"]}),

  C("V","Card 60","Uphill or downhill, left to right",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"gradient-sign",ground:"g0",buildsOn:["Card 59"]}),

  C("V","Card 61","No rise at all",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"zero-gradient",ground:"g0",buildsOn:["Card 59"]}),

  C("V","Card 62","When the formula breaks",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"undefined-gradient; vertical-line",ground:"g0",buildsOn:["Card 59"]}),

  C("V","Card 63","One equation, every point on the line",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"line-equation; y-mx-c",ground:"g0",buildsOn:["Card 59"]}),

  C("V","Card 64","Two knobs, two jobs",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"m-and-c-roles",ground:"g0",buildsOn:["Card 63"]}),

  C("V","Card 65","Reverse-engineering the line",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"equation-from-two-points",ground:"g0",buildsOn:["Card 59","Card 63"]}),

  C("V","Card 66","Same lean, different position",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"parallel-lines",ground:"g0",buildsOn:["Card 63"]}),

  C("V","Card 67","Meeting at a perfect right angle",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"perpendicular-lines; negative-reciprocal",ground:"g0",buildsOn:["Card 63"]}),

  C("V","Card 68","Setting y to zero",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"x-intercept; root",ground:"g0",buildsOn:["Card 63"]}),

  C("V","Card 69","Setting x to zero",[
  ...
  ],null,{subject:"maths",topic:"coordinate-geometry",concept:"y-intercept",ground:"g0",buildsOn:["Card 63"]}),

  C("V","Card 70","One point, shared by two equations",[
