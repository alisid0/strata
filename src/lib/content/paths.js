...
export const PATHS = {
  ...
  PFINAL_CHEM: { subject: 'chemistry', name: '★ Final draft — review (chemistry)', icon: 'chemistry', cards: [1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063], quizUrls: [] }
};
