...
export const PATHS = {
  ...
  PFINAL_CHEM: { subject: 'chemistry', name: '★ Final draft — review (chemistry)', icon: 'chemistry', cards: [1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053], quizUrls: [] }
};
